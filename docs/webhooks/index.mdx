...
Don't know what a webhook is? Learn more from this [What are
webhooks?](https://zapier.com/blog/what-are-webhooks/) blog post.
...
Every.org webhooks come in two flavors - the [Nonprofit Donation
Webhook](./nonprofit-webhook.mdx) and the [Partner webhook](./partner-webhook.mdx).
...
Read more about setting up a Nonprofit Donation
Webhook for your nonprofit [here](./nonprofit-webhook.mdx).
